const caseStudies = [
  {
    ...
    industry: "VFX Studio",
    headline: "Custom tools that replaced manual busywork across an entire VFX studio",
    results: [
      "Pulse — one screen to track deals, project progress, team schedules, invoices, and tasks. No more switching between five apps.",
      "Media Scanner — incoming files get checked and organized automatically. Bad names get flagged before they cause problems downstream.",
      "inFLOW — new work from vendors, clients, and internal teams gets logged and routed to the right place without anyone touching it.",
      "Ingestor — files land in the correct folders on their own. No more dragging, renaming, or hoping someone put it in the right spot.",
    ],
    tools: ["Pulse", "Media Scanner", "inFLOW", "Ingestor"],
  },
  {
