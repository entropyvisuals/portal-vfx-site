const caseStudies = [
  {
    ...
    industry: "VFX Studio",
    headline: "From spreadsheets to a fully automated production pipeline",
    results: [
      "6,200+ VFX projects tracked automatically",
      "Multi-entity financial reporting across 4 countries",
      "AI agents handle daily data processing, backups, and alerts",
      "Zero manual data entry — everything flows from source to dashboard",
    ],
    tools: ["Custom Pipeline", "AI Agents", "Financial Dashboards", "Automated Backups"],
  },
  {
